!function(){function e(e,t,r,s){Object.defineProperty(e,t,{get:r,set:s,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},s={},a={},c=r.parcelRequired7c6;null==c&&((c=function(e){if(e in s)return s[e].exports;if(e in a){var t=a[e];delete a[e];var r={id:e,exports:{}};return s[e]=r,t.call(r.exports,r,r.exports),r.exports}var c=Error("Cannot find module '"+e+"'");throw c.code="MODULE_NOT_FOUND",c}).register=function(e,t){a[e]=t},r.parcelRequired7c6=c);var n=c.register;n("iE7OH",function(t,r){e(t.exports,"register",function(){return s},function(e){return s=e});var s,a=new Map;s=function(e,t){for(var r=0;r<t.length-1;r+=2)a.set(t[r],{baseUrl:e,path:t[r+1]})}}),n("aNJCr",function(t,r){e(t.exports,"getBundleURL",function(){return s},function(e){return s=e});var s,a={};s=function(e){var t=a[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),a[e]=t),t}}),c("iE7OH").register(c("aNJCr").getBundleURL("86U9d"),JSON.parse('["86U9d","cart.85915388.js","8AgqT","icons.ba4cab42.svg","hRigT","success.bc633c77.webp","ceYlc","cart.9dadeef2.js"]')),c("7hKzD"),c("i8Q71");let o=document.querySelector(".js-cart-span"),l=document.querySelector(".js-all-cart-content"),i=document.querySelector(".js-cart-list"),d=document.querySelector(".js-order-container"),u=document.querySelector(".js-empty-cart"),p=document.querySelector(".js-delete-all");document.querySelector(".js-delete");var f={cartSpan:o,cartContent:l,productList:i,customerOrder:d,emptyCart:u,deleteAll:p,successModal:document.querySelector(".js-success")},m=c("81wSt"),v={};v=c("aNJCr").getBundleURL("86U9d")+"icons.ba4cab42.svg";var y=c("i8Q71"),h=c("gnsaF"),g={};g=c("aNJCr").getBundleURL("86U9d")+"success.bc633c77.webp",window.addEventListener("load",C);let b=new m.FoodBoutiqueAPI;function L({_id:e,name:r,img:s,category:a,size:c,price:n}){return`
    ...
    `}function S(e){let t=function(e){let t=0;for(let r of e){let e=void 0===r.quantity?1:r.quantity;t+=r.price*e}return parseFloat(t.toFixed(2))}(e);f.customerOrder.innerHTML=`
    ...
    `}async function C(){(0,y.updateCartFromStorage)(f.cartSpan),(0,y.updateCartOnHeader)();let e=localStorage.getItem("localKey");if(!e||"[]"===e){f.cartContent.classList.add("visually-hidden"),f.emptyCart.classList.remove("visually-hidden");return}let t=JSON.parse(localStorage.getItem("localKey"));try{let e=t.map(e=>b.fetchCachedById(e)),r=await Promise.all(e);!function(e){let t=e.map(L).join("");f.productList.insertAdjacentHTML("beforeend",t)}(r),S(r)}catch(e){console.error(e)}f.productList.children.length>3?f.productList.classList.add("show-scroll"):f.productList.classList.remove("show-scroll")}function q(){f.successModal.classList.add("is-hidden"),(0,h.enableBodyScroll)(f.successModal),localStorage.clear(),f.cartContent.classList.add("visually-hidden"),f.emptyCart.classList.remove("visually-hidden")}f.productList.addEventListener("click",e=>{let t=e.target;if(t.classList.contains("counter-btn")){let e=t.closest(".cart-list-item").querySelector(".counter-value"),r=t.getAttribute("data-action"),s=parseInt(e.textContent);"increment"===r?s++:"decrement"===r&&s>1&&s--,e.textContent=s,function(){let e=f.productList.querySelectorAll(".cart-list-item"),t=[];e.forEach(e=>{let r=e.getAttribute("data-product-id"),s=parseFloat(e.querySelector(".cart-price").textContent.replace("$","")),a=parseInt(e.querySelector(".counter-value").textContent);t.push({_id:r,price:s,quantity:a})}),S(t)}()}}),f.customerOrder.addEventListener("submit",async e=>{e.preventDefault();let r=document.getElementById("email").value,s=f.productList.querySelectorAll(".cart-list-item"),a=[];s.forEach(e=>{let t=e.getAttribute("data-product-id"),r=parseFloat(e.querySelector(".cart-price").textContent.replace("$","")),s=parseInt(e.querySelector(".counter-value").textContent);a.push({_id:t,price:r,quantity:s})});try{let e=await b.postOrders(r,a);if(e){var c;c=e.message,f.successModal.innerHTML=`<div class="success-modal">
