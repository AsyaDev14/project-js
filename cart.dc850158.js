!function(){function e(e,t,r,a){Object.defineProperty(e,t,{get:r,set:a,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},n=t.parcelRequired7c6;null==n&&((n=function(e){if(e in r)return r[e].exports;if(e in a){var t=a[e];delete a[e];var n={id:e,exports:{}};return r[e]=n,t.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){a[e]=t},t.parcelRequired7c6=n);var o=n.register;o("iE7OH",function(t,r){e(t.exports,"register",function(){return a},function(e){return a=e});var a,n=new Map;a=function(e,t){for(var r=0;r<t.length-1;r+=2)n.set(t[r],{baseUrl:e,path:t[r+1]})}}),o("aNJCr",function(t,r){e(t.exports,"getBundleURL",function(){return a},function(e){return a=e});var a,n={};a=function(e){var t=n[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),n[e]=t),t}}),n("iE7OH").register(n("aNJCr").getBundleURL("86U9d"),JSON.parse('["86U9d","cart.dc850158.js","8AgqT","icons.f68dd9ec.svg","8qwPN","cart.b83e1453.js"]')),n("7hKzD"),n("i8Q71");let c=document.querySelector(".js-cart-span"),l=document.querySelector(".js-all-cart-content"),s=document.querySelector(".js-cart-list"),i=document.querySelector(".js-order-container"),d=document.querySelector(".js-empty-cart"),u=document.querySelector(".js-delete-all");document.querySelector(".js-delete"),document.querySelector(".js-success");var p={cartSpan:c,cartContent:l,productList:s,customerOrder:i,emptyCart:d,deleteAll:u},f=n("81wSt"),m={};m=n("aNJCr").getBundleURL("86U9d")+"icons.f68dd9ec.svg";var v=n("i8Q71");window.addEventListener("load",h);let y=new f.FoodBoutiqueAPI;function g({_id:e,name:t,img:r,category:a,size:n,price:o}){var c;return`
    ...
    `}function b(e){let t=function(e){let t=0;for(let r of e){let e=void 0===r.quantity?1:r.quantity;t+=r.price*e}return parseFloat(t.toFixed(2))}(e);p.customerOrder.innerHTML=`
    ...
    `}async function h(){if((0,v.updateCartFromStorage)(p.cartSpan),(0,v.updateCartOnHeader)(),null===localStorage.getItem("localKey")){p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden");return}let e=JSON.parse(localStorage.getItem("localKey"));try{let t=e.map(e=>y.fetchById(e)),r=await Promise.all(t);!function(e){let t=e.map(g).join("");p.productList.insertAdjacentHTML("beforeend",t)}(r),b(r),p.productList.addEventListener("click",e=>{let t=e.target;if(t.classList.contains("counter-btn")){let e=t.getAttribute("data-action"),a=t.parentElement.querySelector(".counter-value"),n=Number(a.textContent);"increment"===e?n++:"decrement"===e&&n>1&&n--,a.textContent=n;let o=t.closest(".cart-list-item").dataset.productId;b(r.map(e=>(e._id===o&&(e.quantity=n),e)));return}})}catch(e){console.error(e)}}var S=n("jzQFI"),v=n("i8Q71");p.deleteAll.addEventListener("click",function(){(0,S.default).remove("localKey"),p.productList.innerHTML="",(0,v.updateCartFromStorage)(p.cartSpan),(0,v.updateCartOnHeader)(),p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden")}),p.productList.addEventListener("click",function(e){if(!e.target.closest(".delete-btn.js-delete"))return;let t=e.target.closest("li").dataset.productId,r=(0,S.default).load("localKey"),a=[];for(let e=0;e<r.length;e++){let n=r[e];n!==t&&a.push(n)}if((0,S.default).remove("localKey"),0===a.length){p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden"),(0,v.updateCartFromStorage)(p.cartSpan),(0,v.updateCartOnHeader)();return}(0,S.default).save("localKey",a),p.productList.innerHTML="",h()})}();
//# sourceMappingURL=cart.dc850158.js.map
