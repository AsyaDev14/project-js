!function(){function t(t,e,r,a){Object.defineProperty(t,e,{get:r,set:a,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},a={},n=e.parcelRequired7c6;null==n&&((n=function(t){if(t in r)return r[t].exports;if(t in a){var e=a[t];delete a[t];var n={id:t,exports:{}};return r[t]=n,e.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){a[t]=e},e.parcelRequired7c6=n);var o=n.register;o("iE7OH",function(e,r){t(e.exports,"register",function(){return a},function(t){return a=t});var a,n=new Map;a=function(t,e){for(var r=0;r<e.length-1;r+=2)n.set(e[r],{baseUrl:t,path:e[r+1]})}}),o("aNJCr",function(e,r){t(e.exports,"getBundleURL",function(){return a},function(t){return a=t});var a,n={};a=function(t){var e=n[t];return e||(e=function(){try{throw Error()}catch(e){var t=(""+e.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(t)return(""+t[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),n[t]=e),e}}),n("iE7OH").register(n("aNJCr").getBundleURL("86U9d"),JSON.parse('["86U9d","cart.c95a9dac.js","8AgqT","icons.fd7a5cf9.svg","ffbzm","cart.b6918210.js"]')),n("7hKzD"),n("i8Q71");let c=document.querySelector(".js-cart-span"),l=document.querySelector(".js-all-cart-content"),s=document.querySelector(".js-cart-list"),i=document.querySelector(".js-order-container"),u=document.querySelector(".js-empty-cart"),d=document.querySelector(".js-delete-all");document.querySelector(".js-delete"),document.querySelector(".js-success");var p={cartSpan:c,cartContent:l,productList:s,customerOrder:i,emptyCart:u,deleteAll:d},f=n("81wSt"),m={};m=n("aNJCr").getBundleURL("86U9d")+"icons.fd7a5cf9.svg";var y=n("i8Q71");window.addEventListener("load",b);let v=new f.FoodBoutiqueAPI;function g({_id:t,name:e,img:r,category:a,size:n,price:o}){var c;return`
    ...
    `}function h(t){let e=function(t){let e=0;for(let r of t){let t=void 0===r.quantity?1:r.quantity;e+=r.price*t}return parseFloat(e.toFixed(2))}(t);p.customerOrder.innerHTML=`
    ...
    `}async function b(){(0,y.updateCartFromStorage)(p.cartSpan),(0,y.updateCartOnHeader)();let t=localStorage.getItem("localKey");if(!t||"[]"===t){p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden");return}let e=JSON.parse(localStorage.getItem("localKey"));try{let t=e.map(t=>v.fetchCachedById(t)),r=await Promise.all(t);!function(t){let e=t.map(g).join("");p.productList.insertAdjacentHTML("beforeend",e)}(r),h(r)}catch(t){console.error(t)}p.productList.children.length>3?p.productList.classList.add("show-scroll"):p.productList.classList.remove("show-scroll")}console.dir(document.querySelector(".input-container #email")),p.productList.addEventListener("click",t=>{let e=t.target;if(e.classList.contains("counter-btn")){let t=e.closest(".cart-list-item").querySelector(".counter-value"),r=e.getAttribute("data-action"),a=parseInt(t.textContent);"increment"===r?a++:"decrement"===r&&a>1&&a--,t.textContent=a,function(){let t=p.productList.querySelectorAll(".cart-list-item"),e=[];t.forEach(t=>{let r=t.getAttribute("data-product-id"),a=parseFloat(t.querySelector(".cart-price").textContent.replace("$","")),n=parseInt(t.querySelector(".counter-value").textContent);e.push({_id:r,price:a,quantity:n})}),h(e)}()}});var L=n("jzQFI"),y=n("i8Q71");p.deleteAll.addEventListener("click",function(){(0,L.default).remove("localKey"),p.productList.innerHTML="",(0,y.updateCartFromStorage)(p.cartSpan),(0,y.updateCartOnHeader)(),p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden")}),p.productList.addEventListener("click",function(t){if(!t.target.closest(".delete-btn.js-delete"))return;let e=t.target.closest("li").dataset.productId,r=(0,L.default).load("localKey"),a=[];for(let t=0;t<r.length;t++){let n=r[t];n!==e&&a.push(n)}if((0,L.default).remove("localKey"),0===a.length){p.cartContent.classList.add("visually-hidden"),p.emptyCart.classList.remove("visually-hidden"),(0,y.updateCartFromStorage)(p.cartSpan),(0,y.updateCartOnHeader)();return}(0,L.default).save("localKey",a),p.productList.innerHTML="",b()})}();
//# sourceMappingURL=cart.c95a9dac.js.map
